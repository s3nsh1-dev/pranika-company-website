        ...
        <Grid container spacing={3} alignItems='center'>
          <Grid item xs={12} md={8}>
            <Typography variant='h6' padding={5}>
              ...
              certification, we further solidify our commitment to excellence.
              Our team of skilled experts ensures that our processes align with
              global best practices, empowering businesses to navigate the
              ever-evolving digital landscape and achieve their goals.
            </Typography>
          </Grid>
        ...
        <Grid container>
          <Grid item xs={12} md={4} sx={{ padding: "5px 20px" }}>
            ...
            <Typography>
              ...
              technology industry. We strive to deliver innovative solutions
              that empower our clients to thrive in the digital age. By
              leveraging our deep expertise and industry insights, we help
              businesses unlock new possibilities and achieve sustainable
              growth.
            </Typography>
          </Grid>
          <Grid item xs={12} md={4} sx={{ padding: "5px 20px" }}>
            ...
            <Typography>
              ...
              continuous learning, and driving positive change in the
          ...
          <Grid item xs={12} md={4} sx={{ padding: "5px 20px" }}>
            ...
            <Typography>
              ...
              professionals. Hailing from various backgrounds and disciplines,
              our experts bring a wealth of knowledge and experience to the
              table. Together, we work in sync to provide tailored solutions
              that address our clients' unique challenges and aspirations.
            </Typography>
          </Grid>
        </Grid>
      </Box>
